...
public class Utf7ImeHelper {
	 ...
	 * https://android.googlesource.com/platform/libcore/+/android-4.4_r1.2/
	...
	/*
	 * The original code is available from
	 * https://android.googlesource.com/platform/libcore/+/android-4.4_r1.2/luni
	 * /src/main/java/java/nio/charset/CharsetEncoder.java
	 */
	// @formatter:on
	...
	/*
	 * The original code is available from
	 * https://android.googlesource.com/platform/libcore/+/master/luni/src/main/
	 * java/java/nio/charset/CharsetEncoder.java
	 */
	// @formatter:on
